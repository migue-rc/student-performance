...
**Conclusions on Supervised Learning:**
Linear Regression performed best with an R2 of ~0.82. It error is less than half a point on average (MAE 0.41).

### Analysis of the Best Model (Linear Regression)
